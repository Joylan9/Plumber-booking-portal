<div align="center">
  <img src="https://images.unsplash.com/photo-1585704032915-c3400ca199e7?q=80&w=2070&auto=format&fit=crop" alt="FlowMatch Banner" style="border-radius: 12px; margin-bottom: 20px; box-shadow: 0 8px 24px rgba(0,0,0,0.15);" />

  <h1 align="center">💧 FlowMatch Enterprise Booking Portal</h1>
...
### 🛡️ Enterprise-Grade Authentication & OTP
*   **Secure Hashing:** AES/SHA-256 equivalent hashing models integrated directly into Mongoose middleware for all user passwords.
*   **6-Digit SMTP OTP Verification:** Real-time email dispatch bridging Node.js algorithms and Nodemailer. Forget primitive URL tokens—users prove identity through dynamically generated 6-digit cryptographic verification exactly like Top 100 Financial Institutions.
...
## 🛠️ Installation & Blueprint Architecture

### Prerequisites
Make sure you have the following installed locally:
- [Node.js (v18+)](https://nodejs.org/en/)
- [MongoDB (Atlas or Compass)](https://www.mongodb.com/)
...
```bash
# Ignite the development runtime
npm run dev
```

**3. Frontend Synthesis**
```bash
cd ../frontend
npm install
npm run dev
...
FROM_EMAIL=noreply@plumberportal.com
FROM_NAME="Plumber Booking Express"
```
> **⚠️ Security Warning:** Never commit `.env` into version control. Ensure it remains securely listed within `.gitignore`. 

---

## 💎 Design System & Component Library

The entire visual library revolves heavily around the custom `var()` token registry embedded globally in `index.css`. 

| Color Theme | Hex Reference | Application Usage |
| :--- | :--- | :--- |
| **Navy Depth** | `#0A2540` | Core Hero layouts, Footer bases, and High-emphasis Typography |
| **Clear Blue** | `#2E86C1` | Focus states, Action Links, Highlighted Gradients |
| **Amber CTA** | `#F0A500` | High-Conversion Buttons, Stars/Ratings, Action Modals |
| **Confirm Green** | `#1A7A4A` | Verification Badges, Success Transitions |
| **Surface Mist** | `#E8F4FD` | Neutral interactive cards and layered background structures |
...
<div align="center">
  ...
  <br/><br/>
  <p><i>Code written with precision. Engineered for scalability. Meticulously designed.</i></p>
</div>
